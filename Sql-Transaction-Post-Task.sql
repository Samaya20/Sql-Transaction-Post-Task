-- Similarly with posts. When an evaluation of the post is made, 
-- it is necessary to recalculate the rating of the post and the 
-- rating of the user who wrote this post.
